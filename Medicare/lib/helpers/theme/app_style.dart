...
import 'package:medicare/helpers/widgets/my.dart';
...
class AppTheme {
  ...
  static Color primaryColor = Color(0xffDCA47C);
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    switchTheme: SwitchThemeData(thumbColor: WidgetStateProperty.resolveWith((states) => states.contains(WidgetState.selected) ? AppTheme.primaryColor : Colors.white)),
