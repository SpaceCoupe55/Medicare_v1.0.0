...
import 'package:medicare/controller/auth/register_account_controller.dart';
                ...
                child: AutofillGroup(
                  child: Column(
                    ...
                    children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                MySpacing.height(8),
                                Semantics(
                                  identifier: 'register-first-name',
                                  label: 'First Name',
                                  child: TextFormField(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: Semantics(
                              identifier: 'register-password-toggle',
                          ...
                          child: MyButton.rounded(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                MyText.labelMedium('Register', fontWeight: 600, color: contentTheme.onPrimary),
                              ],
                            ),
                          ),
                        ),
                      ...
                      Center(
                        child: Semantics(
                          identifier: 'register-back-to-login',
                          ...
                          child: MyButton.text(
                            ...
                            child: MyText.labelMedium('Already have account ?', color: contentTheme.secondary),
                          ),
                        ),
                      ),
                    ],
